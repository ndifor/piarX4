...
--------------------------
If you want to run a quick demo of PiarX4 or run it permanently in the cloud, then we
...
5. Create a new node on DigitalOcean through the `Infrastructure > Nodes` tab. Fill in a name (PiarX4) and choose a region near to you
...
--------------------------
From now on PiarX4 can be deployed using Docker on Linux, Mac or Windows. This setup dramatically reduces the number of possible issues as all setup is now done in a Dockerfile. Docker runs natively on mac and linux, but will require more overhead on windows. Please refer to the docker documentation for instructions on how to set it up on your platform.
